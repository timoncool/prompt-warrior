...
3а. Фавикон и печать: логотип проекта — герб «перекрещенные мечи + щит» с монограммой
   ...
   game-icons/lorc, CC-BY-3.0). В <head> — data-URI SVG-фавикон (круг #8B2635 + герб
   #E8CFB4 + text PW Georgia bold цветом круга, urlencoded — карточка остаётся
   автономным файлом). В футере .seal — тот же герб 32px с PW цветом #5E1822.
