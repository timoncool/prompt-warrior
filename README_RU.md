...
- **Прикольные статусы** — титул из поведения (эпитет + звание + уровень), 58 ачивок от common до legendary, шесть шкал (Ярость, Теплота, Дотошность, Совиность, Нетерпеливость, Кэш-скряга)
